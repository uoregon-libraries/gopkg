...
func TestSum(t *testing.T) {
	var tests = []struct {
		...
		{"SHA256", SHA256(), "test", "9f86d081884c7d659a2feaa0c55ad015a3bf4f1b2b0b822cd15d6c15b0f00a08"},
		{"SHA512", SHA512(), "test", "ee26b0dd4af7e749aa1a8ee3c10ae9923f618980772e473f8819a5d4940e0db27ac185f8a0e1d5f84f88bc887fd67b143732c304cc5fa9ad8e6f57f50028a8ff"},
	}
...
func TestFileSum(t *testing.T) {
	var tests = []struct {
		...
		{"MD5 test.txt", MD5(), "testdata/test.txt", "2490a3d39b0004e4afeb517ef0ddbe2d", false},
		{"SHA1 test.txt", SHA1(), "testdata/test.txt", "b54e43082887d1e7cdb10b7a21fe4a1e56b44b5a", false},
		{"SHA256 test.txt", SHA256(), "testdata/test.txt", "3cd203ac11340842055a6de561c9d69ca4493e912bd4c3c440c80711e16d5aee", false},
		{"MD5 test2.bin", MD5(), "testdata/test2.bin", "84f053268f5341dfbd8c7373d9155992", false},
		{"SHA512 missing", SHA512(), "testdata/missing.txt", "", true},
	}
